...
plt.xlabel('户型名')
plt.ylabel('户型数量')
plt.title('天津市户型数量分布图')
plt.legend()
plt.savefig('天津市户型数量分布图.png')
...
plt.xlabel('房屋朝向')
plt.ylabel('频数')
plt.title('天津市房屋朝向分布图')
plt.legend()
plt.savefig('天津市房屋朝向分布图.png')
...
plt.xlabel('装修类型')
plt.ylabel('频数')
plt.title('天津市装修类型分布图')
plt.legend()
plt.savefig('天津市装修类型分布图.png')
